...
class RewardSystem:
    ...
    def calculate_reward(self, game_manager, game_over, prev_score, new_score, num_players=1, player_index=0):
        """
        ...
        Args:
            ...
            player_index: Index of the player to calculate reward for (default: 0)
        ...
        if num_players == 1:
            ...
            if player_index >= len(game_manager.snakes) or not game_manager.snake_alive[player_index]:
        ...
        if player_index in self.prev_distance_to_apple and self.prev_distance_to_apple[player_index] is not None and min_distance_to_apple < float('inf'):
            # Reward for getting closer to green apple, penalize for moving away
            distance_change = self.prev_distance_to_apple[player_index] - min_distance_to_apple
        ...
        if num_players > 1:
            ...
            if active_other_snakes > 0:
                ...
                length_advantage = (current_length - other_snakes_avg_length) * 0.01
